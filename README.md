...
| Tests | Passing | 1304/1304 as of this commit (plus 30 engine-dependent tests behind `NBODY6_BINARY_TESTS=1` and a GPU-gated set behind `NBODY6_GPU_TESTS=1`), incl. physics validation, adversarial external-input tests, telemetry/thread-control, per-cluster structure, restart, and tidal-field tests |
