...
| Tests | Passing | 1036/1036 as of this commit (plus 30 engine-dependent tests behind `NBODY6_BINARY_TESTS=1`), incl. physics validation, adversarial external-input tests, telemetry/thread-control, per-cluster structure, restart, and tidal-field tests |
